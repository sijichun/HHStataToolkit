*! test_local_polynomial_performance_large.do
*! Large-N performance benchmark for local polynomial regression
...
display as text "Local Polynomial Regression Performance Benchmark (Large N)"
